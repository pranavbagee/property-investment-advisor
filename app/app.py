...
def load_advisor():
    return PropertyInvestmentAdvisor(
        ...
        feature_lists_path=os.path.join(os.path.dirname(__file__), "..", "models", "feature_lists.json"),
        appreciation_path=os.path.join(os.path.dirname(__file__), "..", "data", "city_appreciation.csv"),
        properties_path=os.path.join(os.path.dirname(__file__), "..", "data", "properties.csv"),
    )
